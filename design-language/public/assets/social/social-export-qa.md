...
- [ ] Target dimensions and safe-zone overlay were checked.
- [ ] Safe-zone overlay and editor notes are removed from the export.
- [ ] Long words, long sources, and real channel compression have been tested.
- [ ] Reddit contribution follows the target community's current rules.
- [ ] GitHub activity is substantive and the preview is under 1 MB.

## Conversion gate

- [ ] Decision Frame is the primary conversion action where a link is appropriate.
- [ ] `utm_source` matches the channel.
- [ ] `utm_medium=organic-social`.
- [ ] `utm_campaign=decision-frame`.
- [ ] `utm_content=<weekly-slug>-<format>`.
